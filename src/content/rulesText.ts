/**
 * Game rules text — edit this file to update the in-game rules screen.
 * Each section starts with a header line, followed by body text.
...
The theoretical Return to Player (RTP) is provided by the platform configuration for the session. The game's probability model is designed to target the configured RTP while keeping outcomes deterministic per step.
